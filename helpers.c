...
/**
 * _printf - This prints a string to stander out put
 * @str: string input
 * Return: void
 */
...
/**
 * free_array - To free an array of pointers
...
/**
 * split - This will split a given string by a delimiter
 * @d: data struct input
 * @delim: string input
 * Return: void
 */
...
/**
 * init_data - A function to init data
 * @d: data struct input
...
/**
 * read_cmd - This function will get the commend from the prompt
 * ..and structure it into data struct
 * @d: data struct input
 * Return: void
 */
void read_cmd(data *d)
{
	...
	d->cmd[nread - 1] = '\0';
	_trim(d->cmd);
	/* This replaces hashtag with end of line we can also do it with strtok*/
	for (i = 0; d->cmd[i] != '\0'; i++)
	{
