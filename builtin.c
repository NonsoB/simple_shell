...
/**
 * exec_builtin - A funct. to check if built in and then exec
 * @d: data struct input
...
/**
 * builtin_exit - This exits the shell
 * @d: data struct input
 * Return: void
 */
...
/**
 * builtin_env - This prints the current environment
 * @d: data struct input
 * Return: void
 */
...
/**
 * builtin_setenv - A funct. to nitialize a new environment variable,
...
/**
 * builtin_unsetenv - This will remove an environment variable
 * @d: data struct input
 * Return: void
 */
